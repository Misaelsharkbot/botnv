...
{title: "👽 | 𝙋𝘼𝙏", description: "ᴜɴ ꜱᴛɪᴄᴋᴇʀ ᴅᴀɴᴅᴏ ᴜɴᴀ ʙᴏꜰᴇᴛᴀᴅᴀ ᴀ ᴀʟɢᴜɪᴇɴ Qᴜᴇ ᴇᴛɪQᴜᴇᴛᴇꜱ", rowId: `${usedPrefix}pat`},
{title: "👽 | 𝙎𝘼𝙇𝙋", description: "ᴜɴ ꜱᴛɪᴄᴋᴇʀ ᴀᴄᴀʀɪᴄɪᴀɴᴅᴏ ᴀ ᴀʟɢᴜɪᴇɴ Qᴜᴇ ᴇᴛɪQᴜᴇᴛᴇꜱ", rowId: `${usedPrefix}slap`},
