...
{title: "🧧 | 𝙏𝙊𝙐𝙍𝙇", description: "", rowId: `${usedPrefix}tourl`},
{title: "🧧 | 𝙏𝙏𝙎", description: "", rowId: `${usedPrefix}tts`},
{title: "🖍️ | 𝙇𝙊𝙂𝙊𝙎", description: "", rowId: `${usedPrefix}logos`},
{title: "🖍️ | 𝙎𝙄𝙈𝙋𝘾𝘼𝙍𝘿", description: "", rowId: `${usedPrefix}simpcard`},
{title: "🖍️ | 𝙃𝙊𝙍𝙉𝙔𝘾𝘼𝙍𝘿", description: "", rowId: `${usedPrefix}hornycard`},
{title: "🖍️ | 𝙇𝙊𝙇𝙄𝘾𝙀", description: "", rowId: `${usedPrefix}lolice`},
{title: "🖍️ | 𝙔𝙏𝘾𝙊𝙈𝙈𝙀𝙉𝙏", description: "", rowId: `${usedPrefix}ytcomment`},
{title: "🖍️ | 𝙄𝙏𝙎𝙎𝙊𝙎𝙏𝙐𝙋𝙄𝘿", description: "", rowId: `${usedPrefix}itssostupid`},
{title: "🖍️ | 𝙋𝙄𝙓𝙀𝙇𝙀𝘼𝙍", description: "", rowId: `${usedPrefix}pixel`},
{title: "🖍️ | 𝘽𝙇𝙐𝙍", description: "", rowId: `${usedPrefix}blur`},
{title: "👾 | 𝘾𝙍𝙄𝙎𝙏𝙄𝘼𝙉𝙊 𝙍𝙊𝙉𝘼𝙇𝘿𝙊", description: "", rowId: `${usedPrefix}cristianoronaldo`},
{title: "👾 | 𝙈𝙀𝙎𝙎𝙄", description: "", rowId: `${usedPrefix}messi`},
{title: "👾 | 𝙈𝙀𝙈𝙀", description: "", rowId: `${usedPrefix}meme`},
{title: "👾 | 𝙄𝙏𝙕𝙔", description: "", rowId: `${usedPrefix}itzy`},
{title: "👾 | 𝘽𝙇𝘼𝘾𝙆𝙋𝙄𝙉𝙆", description: "", rowId: `${usedPrefix}blackpink`},
{title: "👾 | 𝙆𝙋𝙊𝙋 𝘽𝙏𝙎", description: "", rowId: `${usedPrefix}kpop bts`},
{title: "👾 | 𝙆𝙋𝙊𝙋 𝙀𝙓𝙊", description: "", rowId: `${usedPrefix}kpop exo`},
{title: "👾 | 𝙆𝙋𝙊𝙋 𝘽𝙇𝘼𝘾𝙆𝙋𝙄𝙉𝙆", description: "", rowId: `${usedPrefix}kpop blackpink`},
{title: "👾 | 𝙇𝙊𝙇𝙄𝙑𝙄𝘿", description: "", rowId: `${usedPrefix}lolivid`},
{title: "👾 | 𝙇𝙊𝙇𝙄", description: "", rowId: `${usedPrefix}loli`},
{title: "👾 | 𝙉𝘼𝙑𝙄𝘿𝘼𝘿", description: "", rowId: `${usedPrefix}navidad`},
{title: "👾 | 𝙋𝘼𝙍𝙀𝙅𝘼", description: "", rowId: `${usedPrefix}ppcouple`},
{title: "👾 | 𝙉𝙀𝙆𝙊", description: "", rowId: `${usedPrefix}neko`},
{title: "👾 | 𝙒𝘼𝙄𝙁𝙐", description: "", rowId: `${usedPrefix}waifu`},
{title: "👾 | 𝘼𝙆𝙄𝙍𝘼", description: "", rowId: `${usedPrefix}akira`},
{title: "👾 | 𝘼𝙆𝙄𝙔𝘼𝙈𝘼", description: "", rowId: `${usedPrefix}akiyama`},
{title: "👾 | 𝘼𝙉𝙉𝘼", description: "", rowId: `${usedPrefix}anna`},
{title: "👾 | 𝘼𝙎𝙐𝙉𝘼", description: "", rowId: `${usedPrefix}asuna`},
{title: "👾 | 𝘼𝙔𝙐𝙕𝘼𝙒𝘼", description: "", rowId: `${usedPrefix}ayuzawa`},
